...
awful.util.spawn_with_shell("razerd")
...
awful.util.spawn_with_shell("xinput set-prop 12 'Device Accel Constant Deceleration' 3")

--{{---| Theme | -------------------------------------

config_dir = ("/home/alec/.config/awesome/")
...
awful.key({ "Control", "Shift"}, "c", function() awful.util.spawn(firefox) end),
